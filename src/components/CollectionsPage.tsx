...
const collections = [
  {
    ...
    movieIds: [942, 1034, 1070, 1663, 756, 1095, 1643, 1677],
  },
  {
    id: "thrill",
    ...
    movieIds: [1220, 1444, 1172, 884, 911, 1206, 549, 952],
  },
  {
    id: "feelbad",
    title: "Поплакать",
    ...
    movieIds: [957, 847, 865, 81, 845, 785, 931, 873],
  },
]
...
export function CollectionsPage({
  ...
  if (selectedCollection && selectedColl) {
    return (
      <div className="relative h-full pt-40 flex justify-center bg-gradient-to-b from-rose-200 via-pink-100 to-neutral-200 pb-4">
        <button
          onClick={onBack}
  ...
  return (
    <div className="relative h-full bg-gradient-to-b from-rose-200 via-pink-100 to-neutral-200 pb-4">
      ...
      <div className="overflow-y-auto no-scrollbar pt-20 px-4 pb-4 h-full">
